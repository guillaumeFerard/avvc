...
install: deps
	...
	@# `make install` installs the editable version of openfisca-avvc.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_avvc openfisca_avvc/tests

serve-local: build
	openfisca serve --country-package openfisca_avvc
